...
class PaymentPayway(http.Controller):
    ...
    def payway_confirmation(self, tx_id, access_token, **kwargs):
        ...
        if tx_id:
            ...
            # TODO : revizar por error de redondeo
            # if not payment_utils.check_access_token(
            #     access_token, tx_sudo.partner_id.id, tx_sudo.amount - tx_sudo.payway_fees, tx_sudo.currency_id.id
            # ):
