    ...
    def _export_for_ui(self, order):
        ...
        if order.account_move:
            ...
            result.update({
                ...
                'l10n_ar_invoice_date': move.invoice_date,
                ...
                'l10n_ar_company_iibb': order.company_id.l10n_ar_gross_income_number,
                'l10n_ar_company_start_date': order.company_id.l10n_ar_afip_start_date,
                'l10n_ar_company_address': order.company_id.partner_id.contact_address,
                'l10n_ar_partner_name': move.partner_id.name,
                'l10n_ar_partner_vat': move.partner_id.vat,
                'l10n_ar_partner_responsibility': move.partner_id.l10n_ar_afip_responsibility_type_id.name,
                'l10n_ar_partner_address': move.partner_id.contact_address,
